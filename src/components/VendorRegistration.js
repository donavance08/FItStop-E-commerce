...
export default function VendorRegistration(){
	...
	}, [email, password1, password2, firstName, lastName, mobileNumber, storeName])

	return (
		<Container className="col-md-7 col-lg-5">
				<Form onSubmit={event => {
					Register(event, firstName, lastName, mobileNumber, email, password1, storeName, "vendor")
					setFirstName("")
					setLastName("")
					setMobileNumber("")
					setEmail("")
					...
					<Form.Group controlId="storeName" className="mt-2">
						<Form.Label>Name your store:</Form.Label>
						<Form.Control
							type="text"   
							value={storeName} 
